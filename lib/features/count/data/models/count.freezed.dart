...
abstract class $CountCopyWith<$Res> {
  ...
  @useResult
  $Res call({int value, String version});
}
...
class _$_Count extends _Count {
  _$_Count({this.value = 0, this.version = ''}) : super._();
  ...
  @override
  String toString() {
    return 'Count(value: $value, version: $version)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, value, version);
...
abstract class _Count extends Count {
  factory _Count({final int value, final String version}) = _$_Count;
  _Count._() : super._();
